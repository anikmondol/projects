...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="container my-3">
        <h1>More on PHP variable</h1>
        <h4>Rules for creating variables in php</h4>
        <ol>
            <li> Starts with a $ sing</li>
            <li> Cannot start with a number</li>
            <li>Must start with a letter or an underscore character</li>
            <li>Can only contain alphanumeric and underscores. ($name and $Name, $namE are different)</li>
            <li>Varialbles in php are case sensitive</li>
            <?php 
                $name = "anik";
                echo "$name";
            ?>
